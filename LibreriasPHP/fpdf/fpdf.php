...
function CellFit($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $scale=false, $force=true)
	...
	function MakeLine()
	{
		...
		while($Length<$this->wTextLine)
		{
			...
			// 	}
			// 	$this->TagName[$i+1]=1;
			// 	// Añadimos una comprobación para asegurarnos de que $tab[2] y el índice 'indent' existen
			// 	if(isset($tab[2]) && isset($this->TagStyle[$tab[2]]) && $this->TagStyle[$tab[2]]['indent'] != -1) {
			// 		$this->LastLine=true;
			//  		$this->Text=trim($this->Text);
			// 		break;
			// 	}
			// 	// Verifica si $tab[2] existe antes de comparar con "a"
			// 	if($tab[2] == "a")
			// 		$this->href="";
			// }
